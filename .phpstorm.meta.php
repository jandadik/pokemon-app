...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Dev_Project\pokemon-app\public\storage' => 'string',
            ...
            'services.workos.api_key' => 'string',
            'services.workos.client_id' => 'string',
            'services.workos.redirect_uri' => 'string',
            'services.workos.connection_id' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.D:\\Dev_Project\\pokemon-app\\public\\storage','logging.default',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.workos.api_key','services.workos.client_id','services.workos.redirect_uri',
'services.workos.connection_id','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'index','hello','card.index','card.show','set.index',
'set.show','login','login.store','logout','user-account.create',
'user-account.store','admin.index','admin.roles.index','admin.roles.create','admin.roles.store',
'admin.roles.edit','admin.roles.update','admin.roles.destroy','admin.permissions.index','admin.permissions.create',
'admin.permissions.store','admin.permissions.edit','admin.permissions.update','admin.permissions.destroy','admin.register-categories.index',
'admin.register-categories.store','admin.register-categories.update','admin.register-categories.destroy','admin.registers.index','admin.registers.store',
'admin.registers.update','admin.registers.destroy','admin.users.index','admin.users.create','admin.users.store',
'admin.users.edit','admin.users.update','admin.users.destroy','profile','profile.update',
'password.update','email.update','notifications.update','settings.update','security.update',
'verification.send','parameters.fetch','login-history.index','test-login-history','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'two-factor.qr-code','two-factor.enable','two-factor.disable','two-factor.verify','two-factor.challenge',
'sessions.destroy','auth.workos','auth.workos.callback',);
        registerArgumentsSet('views', 
'app','emails.login-notification','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'VITE_APP_NAME','WORKOS_API_KEY','WORKOS_CLIENT_ID','WORKOS_REDIRECT_URL',);
