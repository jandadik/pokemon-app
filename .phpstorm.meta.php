...
'admin.users.edit','admin.users.update','admin.users.destroy','profile.index','profile.update',
'password.update','email.update','settings.update','verification.send','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'two-factor.qr-code','two-factor.enable','two-factor.disable','two-factor.verify','sessions.destroy',);
