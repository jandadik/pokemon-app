...
return [
    ...
    */
    ...
    'form' => [
        ...
        'note' => 'Note',
        'notes' => 'Notes',
        'notes_placeholder' => 'Optional notes about this card...',
        'variant' => 'Variant',
        'variant_required' => 'Please select a card variant',
        'condition_required' => 'Please select card condition',
        'language_required' => 'Please select card language',
        'quantity_required' => 'Please enter quantity',
        'quantity_min' => 'Quantity must be at least 1',
        'quantity_max' => 'Quantity cannot be more than 999',
        'save' => 'Save',
        'cancel' => 'Cancel',
        'errors' => [
    ...
    'add_to_collection' => [
        ...
        'auto_save_info' => 'Card will be added to your default collection: :collection',
        'add_button' => 'Add to Collection',
        'success' => 'Card was successfully added to the collection!',
        'error' => 'An error occurred while adding the card to the collection.',
        'error_loading_collections' => 'Failed to load collections list.',
        'error_loading_variants' => 'Failed to load card variants.',
    ],
