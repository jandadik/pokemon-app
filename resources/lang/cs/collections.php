...
return [
    ...
    */
    ...
    'form' => [
        ...
        'note' => 'Poznámka',
        'notes' => 'Poznámky',
        'notes_placeholder' => 'Nepovinné poznámky k této kartě...',
        'variant' => 'Varianta',
        'variant_required' => 'Vyberte variantu karty',
        'condition_required' => 'Vyberte stav karty',
        'language_required' => 'Vyberte jazyk karty',
        'quantity_required' => 'Zadejte počet kusů',
        'quantity_min' => 'Počet musí být alespoň 1',
        'quantity_max' => 'Počet nesmí být větší než 999',
        'save' => 'Uložit',
        'cancel' => 'Zrušit',
        'errors' => [
    ...
    'add_to_collection' => [
        ...
        'select_collection' => 'Vyberte sbírku',
        'select_variant' => 'Vyberte variantu karty',
        'collection_required' => 'Vyberte sbírku',
        'auto_save_info' => 'Karta bude přidána do vaší výchozí sbírky: :collection',
        'add_button' => 'Přidat do sbírky',
        'success' => 'Karta byla úspěšně přidána do sbírky!',
        'error' => 'Při přidávání karty do sbírky došlo k chybě.',
        'error_loading_collections' => 'Nepodařilo se načíst seznam sbírek.',
        'error_loading_variants' => 'Nepodařilo se načíst varianty karty.',
    ],
